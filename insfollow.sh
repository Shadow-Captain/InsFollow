...
echo -e "\e[1;91m ═╩═\e[1;92m         \e[1;91m╩   by - \e[1;92mShadow-Captain"
...
read -p $'  \e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Nombre de usuario: \e[0m' user
fi

if [[ -e cookie.$user ]]; then

printf "  \e[1;31m[\e[0m\e[1;77m*\e[0m\e[1;31m]\e[0m\e[1;93m Cookies encontradas para el usuario\e[0m\e[1;77m %s\e[0m\n" $user

default_use_cookie="Y"

read -p $'  \e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m ¿Usarlo?\e[0m\e[1;77m [Y/n]\e[0m ' use_cookie

use_cookie="${use_cookie:-${default_use_cookie}}"

if [[ $use_cookie == *'Y'* || $use_cookie == *'y'* ]]; then
printf "  \e[1;31m[\e[0m\e[1;77m*\e[0m\e[1;31m]\e[0m\e[1;93m Uso de credenciales guardadas\e[0m\n"
else
rm -rf cookie.$user
login_user
fi
...
printf "\n"
printf "  \e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Esta técnica consiste en seguir/no seguir a los famosos\e[0m\n"
printf "  \e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Puede aumentar tus seguidores hasta aproximadamente +30 en 1 hora \e[0m\n"
printf "  \e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m]\e[0m\e[1;93m Presione Ctrl + C para detener \e[0m\n"
printf "\n"
sleep 5
...
if [[ ! -e celeb_id ]]; then
printf " %s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n" $dualipa $celebrity $mileycyrus $shawnmendes $katyperry $charlieputh $lelepons $camila_cabello $madonna $leonardodicaprio $ladygaga $taylorswift $instagram $neymar $selena $ariana $beyonce $soldier_scp $cristiano $kimkardashian $kendall $therock $kylie $jelopez $messi> celeb_id
fi
...
hmac=$(echo -n "$data" | openssl dgst -sha256 -hmac "${ig_sig}" | cut -d " " -f2)
printf " \e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Tratando de seguir celebgram %s ..." $celeb
...
printf " \n\e[1;31m [!] Error\n"
printf " \n\e[1;33m [::] Hay un problema en tu cuenta de instagram\n"
printf " \n\e[1;31m [:] Razón\n"
printf " \n\e[1;33m - Ha alcanzado el límite de seguimiento/dejar de seguir de Instagram de hoy\n."
printf " \n\e[1;33m - Tu cuenta está bloqueada temporalmente por instagram\n"
printf " \n\e[1;32m [:] Solución\n"
printf " \n\e[1;33m - No siga ni deje de seguir a nadie en Instagram durante 24 horas y luego vuelva a ejecutar el script, funcionará.\n"

exit 1
else
printf " \e[1;92mÉxito\e[0m\n"
fi
sleep 3

done
printf " \e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;77m Descanso 60 segundos...\e[0m\n"
sleep 60
#unfollow
for celeb in $(cat celeb_id); do
data='{"_uuid":"'$guid'", "_uid":"'$username_id'", "user_id":"'$celeb'", "_csrftoken":"'$var2'"}'
hmac=$(echo -n "$data" | openssl dgst -sha256 -hmac "${ig_sig}" | cut -d " " -f2)
printf " \e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Tratando de dejar de seguir a celebgram %s ..." $celeb
...
printf "\n \e[1;93m [!] Error, deteniéndose para evitar el bloqueo\n"
printf " \e[1;33m [-] Has alcanzado el límite de hoy. Intenta mañana de nuevo.\n"
printf " \e[1;33m [-] Hemos establecido un límite para evitar el bloqueo de su cuenta de Instagram.\n"
exit 1
else
printf " \e[1;92mÉxito\e[0m\n"
fi
...
printf " \e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;77m Descanso 60 segundos para prevenir bloqueos...\e[0m\n"
sleep 60
...
read -p $' \e[1;31m[\e[0m\e[1;77m::\e[0m\e[1;31m]\e[0m\e[1;77m Elige una opcion: \e[0m' option
